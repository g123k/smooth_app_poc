...
class NewsPage extends StatelessWidget {
  ...
  InlineSpan _generateContent(TextStyle style) {
    return TextSpan(
      children: const <TextSpan>[
        ...
        TextSpan(
          text: 'Faible teneur en matières grasses : ',
          style: TextStyle(fontWeight: FontWeight.bold),
        ),
        TextSpan(
            text:
                'Le Nesquik, étant principalement composé de cacao en poudre, a généralement une faible teneur en matières grasses, ce qui améliore son Nutri-Score.\n\n'),
        TextSpan(
          text: 'Faible teneur en matières grasses : ',
          style: TextStyle(fontWeight: FontWeight.bold),
        ),
        ...
        TextSpan(
          text: 'Faible teneur en sel : ',
          style: TextStyle(fontWeight: FontWeight.bold),
        ),
        TextSpan(
            text:
                'Le Nesquik contient généralement peu ou pas de sel, ce qui est également un facteur positif.\n\n'),
        TextSpan(
          text: 'Portion recommandée : ',
          style: TextStyle(fontWeight: FontWeight.bold),
        ),
        TextSpan(
            text:
                'Le Nutri-Score est souvent calculé sur la base de la portion recommandée. Si cette portion est petite, cela peut également contribuer à un meilleur score.\n\n'),
        TextSpan(
          text: 'Formulation spécifique : ',
          style: TextStyle(fontWeight: FontWeight.bold),
        ),
        TextSpan(
            text:
                'Certains produits Nesquik peuvent être formulés pour être plus sains, avec par exemple moins de sucre ajouté, ce qui peut contribuer à un meilleur Nutri-Score.\n\n'),
        TextSpan(
        ...
        TextSpan(
            text:
                'Le Nutri-Score est également relatif à la catégorie de produits. Si la plupart des produits similaires ont un profil nutritionnel moins favorable, le Nesquik peut se distinguer avec un meilleur score.\n\n'),
        TextSpan(
            text:
